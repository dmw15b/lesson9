...
/*  Section #4:  AJAX code to send the HTTP Request, which is the location the user specifies, to the 
    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 Use the following code as an example:
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=ef21c6bed2a94737bf2205738161704,
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                .done(function(json){
                     ...
                     $('#Day3Low').html("<center>" + json.forecast
                         .forecastday[2].day.maxtemp_f + "<center>");
                     $('#Day3High').html("<center>" + json.forecast
                         .forecastday[2].day.maxtemp_f + "</center>");  
                     $('#Day4Low').html("<center>" + json.forecast
                         .forecastday[3].day.maxtemp_f + "<center>");
                     $('#Day4High').html("<center>" + json.forecast
                         .forecastday[3].day.maxtemp_f + "</center>");  
                     $('#Day5Low').html("<center>" + json.forecast
                         .forecastday[4].day.maxtemp_f + "<center>");
                     $('#Day5High').html("<center>" + json.forecast
                         .forecastday[4].day.maxtemp_f + "</center>");  
                     $('#Day6Low').html("<center>" + json.forecast
                         .forecastday[5].day.maxtemp_f + "<center>");
                     $('#Day6High').html("<center>" + json.forecast
                         .forecastday[5].day.maxtemp_f + "</center>");  
                     $('#Day7Low').html("<center>" + json.forecast
                         .forecastday[6].day.maxtemp_f + "<center>");
                     $('#Day7High').html("<center>" + json.forecast
                         .forecastday[6].day.maxtemp_f + "</center>");  
                     $('#Day8Low').html("<center>" + json.forecast
                         .forecastday[7].day.maxtemp_f + "<center>");
                     $('#Day8High').html("<center>" + json.forecast
                         .forecastday[7].day.maxtemp_f + "</center>");  
                     $('#Day9Low').html("<center>" + json.forecast
                         .forecastday[8].day.maxtemp_f + "<center>");
                     $('#Day9High').html("<center>" + json.forecast
                         .forecastday[8].day.maxtemp_f + "</center>");  
                     $('#Day10Low').html("<center>" + json.forecast
                         .forecastday[9].day.maxtemp_f + "<center>");
                     $('#Day10High').html("<center>" + json.forecast
                         .forecastday[9].day.maxtemp_f + "</center>");  
